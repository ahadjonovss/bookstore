...
class EditCategoryDialog extends StatelessWidget {
  ...
  EditCategoryDialog({required this.category,required this.categoryController,Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    TextButton(onPressed: () async {
                      if(categoryController.text.length<5){
                        ...
                        // ignore: use_build_context_synchronously
                        MySnackBar(context, notification: "Name of category changed succesfully!", color: Colors.green, icon: const Icon(Icons.info_rounded,color: Colors.white,));
                      }
